...
<style>
    ...
    @media (max-width: 900px) {
        .forgot-wrapper { width: 98vw; }
        .forgot-right { width: 100%; padding: 32px 12vw; border-radius: 0; }
...
<div class="forgot-wrapper">
    <div class="forgot-right">
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <input type="email" name="email" id="email" class="auth-input" required autofocus value="{{ old('email') }}">
            @error('email')
